return {
    ...
    -- Flash enhances the built-in search functionality by showing labels at the end of each match, letting you quickly jump to a specific location.
    {
        ...
        keys = {
            ...
            { "S", mode = { "n", "o", "x" }, function() pcall(require("flash").treesitter) end, desc = "Flash Treesitter" },
            { "r", mode = "o", function() require("flash").remote() end, desc = "Remote Flash" },
            { "R", mode = { "o", "x" }, function() pcall(require("flash").treesitter_search) end, desc = "Treesitter Search" },
